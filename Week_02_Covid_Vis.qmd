...
I saw that White as pink line is high towars other races. 

2. Are there any conclusions you can draw?
White is keeping a higher number of death toward the overall race.

3. What were you not able to do due to not having the R knowledge?
make a prediction model of future death rate for each race.

4. What other data would be useful to better understand this data?
Age of these people who dead.
